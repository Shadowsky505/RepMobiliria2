...
$agentes = $sentencia->fetch(PDO::FETCH_OBJ);
    ...
    CURLOPT_POSTFIELDS => array(
        ...
        'caption' => 'Querido agente: '.strtoupper($agentes->nombres).' '.strtoupper($agentes->apellidos).' le hemos los recursos necesarios para el nuevo proyecto. REVISAR',
        'file' => curl_file_create('imagenes/POST.jpg', 'image/jpeg', 'POST.jpg')
    ),
